...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $subject = "Prośba o dostęp";
    $message = "Prośba o dostęp do aplikacji\nE-mail od: $email";
    $headers = "From: $email";
...
<h1><a class="kupa" href="index.html" style="color: #ffffff; text-decoration: none; font-size:2rem;">e-Wishes</a></h1>
    ...
    <?php else: ?>
        <p>Wpisz swój adres e-mail, a my skontaktujemy się z Tobą w sprawie dostępu do aplikacji.</p>
        <form action="dostep.php" method="post">
